...
func main() {
	...
	// parse args
	deviceID := 0
  model := "/home/pi/dev/gobotAssets/bvlc_googlenet.caffemodel"
  config := "/home/pi/dev/gobotAssets/bvlc_googlenet.prototxt"
  descr := "/home/pi/dev/gobotAssets/classification_classes_ILSVRC2012.txt"
